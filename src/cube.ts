...
const [centerFacelet, cornerFacelet, edgeFacelet] = Array.from((function() {
...
var Cube = (function() {
  ...
  Cube = class Cube {
    ...
    static initClass() {
      ...
      this.prototype.randomize = (function() {
        ...
        const getNumSwaps = function(arr: { length?: any; }) {
          let numSwaps = 0;
          const seen = (__range__(0, arr.length - 1, true).map((x: any) => false));
        ...
        const randomizeOrientation = function(arr: { length?: any; }, numOrientations: number) {
          let ori = 0;
          for (let i = 0, end = arr.length - 1, asc = 0 <= end; asc ? i <= end : i >= end; asc ? i++ : i--) {
        ...
        const isOrientationValid = (arr: { reduce: (arg0: (a: any, b: any) => any) => number; }, numOrientations: number) => (arr.reduce((a: any, b: any) => a + b) % numOrientations) === 0;
    ...
    init(state: { center: { slice: (arg0: number) => any; }; co: { slice: (arg0: number) => any; }; ep: { slice: (arg0: number) => any; }; cp: { slice: (arg0: number) => any; }; eo: { slice: (arg0: number) => any; }; }) {
